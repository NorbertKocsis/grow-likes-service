...
/**
 * Provides the local service interface for AssetLike. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AssetLikeLocalServiceUtil
...
public interface AssetLikeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssetLikeLocalServiceUtil} to access the asset like local service. Add custom service methods to {@link com.liferay.grow.likes.service.impl.AssetLikeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AssetLike addAssetLike(AssetLike assetLike);
	...
	*/
	...
	public AssetLike createAssetLike(long id);
	...
	*/
	...
	public AssetLike deleteAssetLike(AssetLike assetLike);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AssetLike deleteAssetLike(long id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AssetLike fetchAssetLike(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AssetLike getAssetLike(long id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AssetLike> getAssetLikes(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AssetLike updateAssetLike(AssetLike assetLike);
}